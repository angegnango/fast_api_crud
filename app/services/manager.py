...
class ManagerService:
    ...
    def get_manager(self, manager_id:int, db:Session):
        return db.query(Manager).filter(Manager.id == manager_id).first()


    def get_manager_by_first_name(self, first_name:str, db:Session):
    ...
    def update(self, manager_id:int, manager:ManageBase, db:Session):
    ...
    def delete(self, manager_id:int, db:Session):
    ...
    def store(self, manager:ManageBase, db:Session):
